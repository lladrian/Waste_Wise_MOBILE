...
import { getSpecificUser } from "../../../hooks/user_hook";
...
export default function ResidentSettingsScreen() {
  const { user, logout, refresh, updateProfile } = useContext(AuthContext)!;
        ...
        <VStack space="lg" p="$4">
          ...
          <VStack space="md">
            ...
            <Box>
              ...
              <VStack space="xs">
                <Link href="/resident/resident-settings/resident-update_profile" asChild>
                  <Button
                    variant="outline"
