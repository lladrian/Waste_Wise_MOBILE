        ...
        {selectedAttendance && (
          <>
            ...
            >
              <VStack space="md">
                <HStack justifyContent="space-between" alignItems="center">
                  <Text size="lg" fontWeight="$bold">Attendance Details</Text>
                  <TouchableOpacity
                    onPress={() => setSelectedAttendance(null)}
                    style={{
                      padding: 8,
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                  <VStack space="md">
                    ...
                    <Card bg="$gray100">
                      <VStack space="sm">
                        ...
                        <HStack justifyContent="space-between">
                          ...
                          <Badge action={selectedAttendance?.truck?.status === "On Route" ? "error" : "success"}>
                            <BadgeText>{selectedAttendance?.truck?.status || "Unknown"}</BadgeText>
                          </Badge>
                        </HStack>
                        <HStack justifyContent="space-between">
                    ...
                    <Card bg="$blue50">
                      <VStack space="sm">
                        <Text fontWeight="$semibold" color="$blue700">Timing Information</Text>
                        <HStack justifyContent="space-between">
                        ...
                        <HStack justifyContent="space-between">
                          ...
                          <Text>{selectedAttendance.ended_at ? formatDateTime(selectedAttendance.ended_at) : "Still in progress"}</Text>
                        </HStack>
                        <HStack justifyContent="space-between">
                          <Text color="$textDark600">Duration:</Text>
                          <Text fontWeight="$bold">{getDuration(selectedAttendance.started_at, selectedAttendance.ended_at)}</Text>
                        </HStack>
                      </VStack>
                    </Card>
                    ...
                    <Card>
                      <VStack space="sm">
                        ...
                        {getCurrentBarangays(selectedAttendance).length > 0 ? (
                          <VStack space="sm">
                            {getCurrentBarangays(selectedAttendance).map((barangay: any, index: number) => (
                              <HStack
                                key={index}
                                justifyContent="space-between"
                                alignItems="center"
                    ...
                    <Card bg="$purple50">
                      <VStack space="sm">
                        <Text fontWeight="$semibold" color="$purple700">Schedule Information</Text>
                        ...
                        <HStack justifyContent="space-between" alignItems="flex-start">
                          ...
                          >
                            {Array.isArray(selectedAttendance.schedule?.recurring_day) && selectedAttendance.schedule.recurring_day.length > 0
                        ...
                        <HStack justifyContent="space-between" alignItems="center">
                          ...
                          <Badge
                            bg={
                              selectedAttendance.schedule?.status === "Scheduled" ? "$green100" :
                                selectedAttendance.schedule?.status === "Completed" ? "$blue100" : "$gray100"
                            }
                            borderColor={
                              selectedAttendance.schedule?.status === "Scheduled" ? "$green300" :
                                selectedAttendance.schedule?.status === "Completed" ? "$blue300" : "$gray300"
                            }
                          >
                            <BadgeText
                              color={
                                selectedAttendance.schedule?.status === "Scheduled" ? "$green700" :
                                  selectedAttendance.schedule?.status === "Completed" ? "$blue700" : "$gray700"
                              }
                            >
                    ...
                    {selectedAttendance?.user && (
                      <Card bg="$green50">
                        <VStack space="sm">
                          <Text fontWeight="$semibold" color="$green700">Driver Information</Text>
                          <VStack space="xs">
                            <HStack justifyContent="space-between">
                            ...
                            <HStack justifyContent="space-between">
                              ...
                              <Text>
                                {selectedAttendance.user.gender?.charAt(0).toUpperCase() +
                                  selectedAttendance.user.gender?.slice(1) || "Not specified"}
                              </Text>
                            </HStack>
                            <HStack justifyContent="space-between">
